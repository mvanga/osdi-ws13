...
The co-existence of two types of cores thus allows the Cell engine to match
...
The key objective in Big.LITTLE is to precisely match the core capabilities to 
